...
if (configOpsJob == null) {
  ...
  SCMSource scm = new GitSCMSource("https://github.com/nickblantz-cbci-1/pipeline-template-catalog.git");
      ...
      <instance>
        ...
        <values class="tree-map">
          ...
          <entry>
            ...
            <string>nickblantz-cbci-1</string>
          </entry>
          <entry>
        ...
        <data>
          <jenkins.branch.BranchSource>
            <source class="org.jenkinsci.plugins.github_branch_source.GitHubSCMSource" plugin="github-branch-source@2.8.3">
              ...
              <repoOwner>nickblantz-cbci-1</repoOwner>
              <repository>pipeline-template-catalog</repository>
              <repositoryUrl>https://github.com/nickblantz-cbci-1/pipeline-template-catalog.git</repositoryUrl>
              <traits>
